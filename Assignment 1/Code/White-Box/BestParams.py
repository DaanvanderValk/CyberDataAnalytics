# -*- coding: utf-8 -*-
"""
Created on Sun May 13 17:06:33 2018
...
# The relevant code for this Task (Find best SMOTE ratio and best params for the classifier) starts at line 133
...
print ("F1 Scores for various SMOTE ratios")
i = 0.05               
while (i<=1.0):
    sm = SMOTE(ratio=i)
...
##Among all the SMOTE ratios, a ratio of 0.05 had the best f1 score but still f1 score is better on non-smoted data
